  ...
  Column buildAuthFields(BuildContext context) {
    return Column(
      children: [
        ...
        const GoogleSignIn(),
        Platform.isAndroid ? Container() : const AppleSignIn(),
      ],
    );
  }
      ...
      if (showConfirmPassword) {
        if (cpasswordController.text.trim().isNotEmpty) {
          if (passwordController.text.trim() ==
            ...
            showCustomFlushbar(
                Strings.generalErrorTitle, Strings.passwordsDontMatch, context);
          }
        } else {
          showCustomFlushbar(
              Strings.generalErrorTitle, Strings.emailPasswordAuth, context);
        }
      } else {
        loginUser();
      }
            ...
            return AlertDialog(
              ...
              content: SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: resetlinkSent
                      ? buildSentDialog()
                      : buildResetDialog(resetPassEmailController, context,
...
BackdropFilter buildResetDialog(TextEditingController resetPassEmailController,
    BuildContext context, StateSetter setState, bool resetlinkSent) {
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                labelStyle:
                    GoogleFonts.sora(color: Colors.white, fontSize: 14)),
          ),
        ),
        const SizedBox(
          height: 0.0,
