...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      await showDialog<String>(
        ...
        builder: (BuildContext context) {
          ...
          return Platform.isIOS
              ? buildiOSDialog(title, message, context, btnLabelCancel,
                  requestAccountDeletion, btnLabel)
              : buildAndroidDialog(title, message, btnLabelCancel, context,
                  btnLabel, requestAccountDeletion);
        },
      );
    }
  ...
  InkWell buildSignOutButton(BuildContext context) {
    return InkWell(
      onTap: () {
        BlocProvider.of<AuthCubit>(context).signOut(context).then((isSuccess) {
          if (isSuccess) {
  ...
  AlertDialog buildAndroidDialog(
      String title,
      String message,
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        ...
        TextButton(
          child:
              Text(btnLabel, style: const TextStyle(color: Colors.redAccent)),
          onPressed: () {
  ...
  CupertinoAlertDialog buildiOSDialog(
      String title,
      String message,
      BuildContext context,
      String btnLabelCancel,
